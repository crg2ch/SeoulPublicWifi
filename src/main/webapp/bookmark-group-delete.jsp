...
<form method="post" action="bookmark-group-delete-submit.jsp" accept-charset="UTF-8">
  <input type="hidden" name="id" value="<%=id%>">
  <table>
    <tr>
      <th style="width: 40%;">북마크 이름</th>
      <td style="width: 60%;"><%=bookmarkGroup.getBookmarkName()%></td>
    </tr>
    <tr>
      <th style="width: 40%;">순서</th>
      <td style="width: 60%;"><%=bookmarkGroup.getOrderId()%></td>
    </tr>
    <tr>
